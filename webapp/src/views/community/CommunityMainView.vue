...
<template>
  <div class="grid px-4 lg:px-0 lg:grid-cols-2 gap-4">
    <div
      class="divide-y sm:divide-y-0 divide-gray-300/50 grid sm:grid-cols-2 rounded-2xl bg-white w-full border-gray-200 border p-5"
    >
