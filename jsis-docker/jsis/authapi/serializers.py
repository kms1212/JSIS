...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        password_chk = data['password_chk']
        email = data['email']
    ...
    def create(self, validated_data):
        ...
        user = UserAccount.objects.create_user(username=username, visiblename=visiblename, password=password, email=email, studentid=studentid)
